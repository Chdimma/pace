            ...
            children: [
              ...
              Row(
                children: [
                  Container(
                    width: 10, height: 10,
                    decoration: const BoxDecoration(shape: BoxShape.circle, color: Color(0xFF764697)),
                  ),
              ...
              Text('Welcome back', style: GoogleFonts.poppins(fontSize: 14, fontWeight: FontWeight.w300, color: const Color(0xFF888888))),
              const SizedBox(height: 4),
              Text('Sign in to your account', style: GoogleFonts.poppins(fontSize: 28, fontWeight: FontWeight.bold, color: Colors.white)),
              const SizedBox(height: 48),
              // Email / Phone input
              FocusScope(
              ...
              Align(
                ...
                child: GestureDetector(
                  ...
                  child: Padding(
                    ...
                    child: Text('Forgot password?', style: GoogleFonts.poppins(color: const Color(0xFF764697), fontSize: 12, fontWeight: FontWeight.w600)),
                  ),
                ),
              ),
