              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    _buildDivider(),
                    _buildSettingsTile(Icons.notifications_none, "Notification", onTap: () => Navigator.push(context, PageRouteBuilder(pageBuilder: (_, _, _) => const NotificationPage(), transitionDuration: Duration.zero, reverseTransitionDuration: Duration.zero))),
                    _buildDivider(),
                    ...
                    _buildDivider(),
                    _buildSettingsTile(Icons.info_outline, "About", onTap: () => Navigator.push(context, PageRouteBuilder(pageBuilder: (_, _, _) => const AboutPage(), transitionDuration: Duration.zero, reverseTransitionDuration: Duration.zero))),
                    _buildDivider(),
                    _buildSettingsTile(Icons.logout, "Log Out", onTap: () => Navigator.push(context, PageRouteBuilder(pageBuilder: (_, _, _) => const LogoutPage(), transitionDuration: Duration.zero, reverseTransitionDuration: Duration.zero))),
                    _buildDivider(),
                    _buildSettingsTile(Icons.delete_outline, "Delete Account", titleColor: _statusRed, iconColor: _statusRed, onTap: () => Navigator.push(context, PageRouteBuilder(pageBuilder: (_, _, _) => const DeleteAccountPage(), transitionDuration: Duration.zero, reverseTransitionDuration: Duration.zero))),
                    _buildDivider(),
